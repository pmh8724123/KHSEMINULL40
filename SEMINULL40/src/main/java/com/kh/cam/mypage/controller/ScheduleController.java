...
public class ScheduleController {
	...
	// 1. 강의 검색 API
	@GetMapping(value = "/searchLecture")
	@ResponseBody
	public List<Lecture> searchLecture(@RequestParam(value="keyword", required=false) String keyword) {
		...
		return sdService.searchLecture(map);
	}
